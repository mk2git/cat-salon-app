<x-admin-layout>
  <div class="container mt-8 mx-auto">
    ...
    <div class="grid gap-6 grid-cols-2 mb-5">
      ...
      <div>
        <p class="text-center">オプションの編集</p>
        @foreach ($options as $option)
          <div class="border rounded p-4 mb-3">
            <form action="{{route('reserve-option.update', $option->id)}}" method="post" class="block mb-3">
              ...
              <button type="submit" class="py-2 px-5 bg-teal-600 text-white font-semibold rounded-full shadow-md hover:bg-teal-600 focus:outline-none focus:ring focus:ring-violet-400 focus:ring-opacity-75 block mx-auto">更新</button>
            </form>
            <hr>
